...
public class SoundManager : MonoBehaviour {
	...
	public AudioClip bounce, bullet_hit_wall, death, empty_gun, equip, execute, explosion, gatline_lazer, hit, hurt, medkit, mercy, pistol, rifle, rpg, shotgun, sin_lazer, sniper, vendor;
